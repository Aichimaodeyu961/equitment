                ...
                <form class="form-horizontal form-label-left" id="updateForm" novalidate="" data-parsley-validate="">
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                            <input class="form-control" type="text" id="user_name" placeholder="请输入用户名" name="user_name" value="${user.user_name}" onblur="checkUsername(this.value)">
                        </div>
                    </div>
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                            <input class="form-control" type="password" id="password" placeholder="请输入密码" name="password" value="${user.password}" >
                        </div>
                    </div>
                    <div class="item form-group">
                    ...
                    <div class="item form-group">
                        <div class="col-md-6 col-sm-6 offset-md-3">
                            ...
                            <a onclick="action('${basePath}/user/updateUser','post','updateForm')">
